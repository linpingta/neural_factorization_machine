...
if __name__ == '__main__':
    ...
    if args.verbose > 0:
        print("Neural FM: dataset=%s, hidden_factor=%d, dropout_keep=%s, layers=%s, loss_type=%s, pretrain=%d, #epoch=%d, batch=%d, lr=%.4f, lamda=%.4f, optimizer=%s, batch_norm=%d, activation=%s, early_stop=%d"
